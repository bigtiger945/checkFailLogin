...
function sendmailto($mailto, $mailsub, $mailbd)
{
    ...
    $smtpusermail   = "iamhwj@qq.com"; //SMTP服务器的用户邮箱
    $smtpemailto    = $mailto;
    $smtpuser       = "iamhwj"; //SMTP服务器的用户帐号
    $smtppass       = "ydxnbsfltxybbjeh"; //SMTP服务器的用户密码
...
class smtp
{
    ...
    function __construct($relay_host = "", $smtp_port = 25, $auth = false, $user, $pass)
    {
        ...
        $this->pass       = $pass;
        #
        $this->host_name  = "smtp.qq.com"; //is used in HELO command
    ...
    function get_attach_type($image_tag) //
    {
        ...
        $extension            = substr($image_tag, strrpos($image_tag, "."), mb_strlen($image_tag) - strrpos($image_tag, "."));
        switch ($extension) {
            case ".gif":
